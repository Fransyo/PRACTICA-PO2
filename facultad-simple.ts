...
class Persona {
    ...
    cambiarEstadoCivil(nuevoEstado: string) {
...
class Estudiante extends Persona {
    ...
    cambiarCurso(nuevoCurso: string) {
...
class SistemaFacultad {
    ...
    editarPersona() {
        ...
        this.personas.forEach((persona, index) => {
            let tipo = "";
            if (persona instanceof Estudiante) tipo = "Estudiante";
            else if (persona instanceof Profesor) tipo = "Profesor";
            else if (persona instanceof PersonalServicio) tipo = "Personal";
